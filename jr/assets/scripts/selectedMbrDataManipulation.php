  ...
  const selectedDataManipulation = (event) => {
    ...
    const editFullData = () => {
      selectedDataEl.innerHTML = `
        ...
        <span class='bold-data-column'>Confirmed Member:</span> <input type='checkbox' name='is-member' ${event.target.dataset.isMember}> <br>
        <br>
        ...
        <br>
        <span class='bold-data-column'>Sponsor Name:</span> <input value='${event.target.dataset.iceName}' name="sponsor-name" required> <br>
        <span class='bold-data-column'>Sponsor Email:</span> <input value='${event.target.dataset.iceEmail}' name="sponsor-email" required> <br>
        <br>
    ...
    const displaySelectedData = () => {
      if (event.target.classList.contains("more-info")) {
        ...
        selectedDataEl.innerHTML = `
          ...
          <span class='bold-data-column'>Confirmed Member:</span> <input type='checkbox' name='myCheckbox' disabled ${event.target.dataset.isMember}> <br>
          <br>
          <span class='bold-data-column'>T-Shirt Size:</span> ${event.target.dataset.tshirtSize} <br>
          <br>
          <span class='bold-data-column'>Spouse Name:</span> ${event.target.dataset.iceName}  <br>
          <span class='bold-data-column'>Spouse Email:</span> ${event.target.dataset.iceEmail} <br>
          <span class='bold-data-column'>Spouse Phone:</span> ${event.target.dataset.icePhone} <br>
          <br>
          <span class='bold-data-column'>Sponsor Name:</span> ${event.target.dataset.iceName}  <br>
          <span class='bold-data-column'>Sponsor Email:</span> ${event.target.dataset.iceEmail} <br>
          <br>
          <span class='bold-data-column'>Last Updated By:</span> ${event.target.dataset.updatedBy} <br>
          <span class='bold-data-column'>Last Updated Date:</span> ${event.target.dataset.updatedDate} <br>
          <span class='bold-data-column'>Deleted By:</span> ${event.target.dataset.deletedBy} <br>
